...
class AdvancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advance" do
    assert_difference('Advance.count') do
      post advances_url, params: { advance: { description: @advance.description, name: @advance.name, operative_plan_id: @advance.operative_plan_id } }
    end
  ...
  test "should update advance" do
    patch advance_url(@advance), params: { advance: { description: @advance.description, name: @advance.name, operative_plan_id: @advance.operative_plan_id } }
